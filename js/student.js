...
const list = document.getElementById('reviewQuestionList') //Find the element that will hold all previewed questions
...
reviewCourseSelect.innerHTML = 'Select a course';
