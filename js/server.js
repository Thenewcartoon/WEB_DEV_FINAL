...
// const query = // SELECT QuestionID, QuestionType, QuestionNarrative, Options // FROM tblAssessmentQuestions // WHERE AssessmentID = ? // ORDER BY QuestionID ASC // ;
...
// Get all active courses
 ...
 const query = `SELECT CourseNumber, CourseName, CourseSection, JoinCode FROM tblCourses`;
...
// Get students in a specific course
 ...
 // const { courseCode } = req.params;
// const query = // SELECT u.FirstName, u.LastName, u.Email // FROM tblEnrollments e // JOIN tblUsers u ON e.StudentEmail = u.Email // WHERE e.CourseNumber = ? // ;
// db.all(query, [courseCode], (err, rows) => {
 // if (err) {
